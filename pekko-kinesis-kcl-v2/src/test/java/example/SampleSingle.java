...
public class SampleSingle {
     ...
     */
    public SampleSingle(String streamName, String region, KinesisAsyncClient kinesisClient, DynamoDbAsyncClient dynamoClient, CloudWatchAsyncClient cloudWatchClient) {
